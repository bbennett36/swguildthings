...
public class CategoryDaoDbImpl implements CategoryDao {
    ...
    private static final String SQL_INSERT_CATEGORY = "insert into category (category) values (?)";
    ...
    private static final String SQL_UPDATE_CATEGORY = "update category set category = ? where id = ?";
    private static final String SQL_LIST_CATEGORIES = "select * from category";
